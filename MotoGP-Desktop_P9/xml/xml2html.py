...
def parse_xml_to_html(xml_file, html_file):
    ...
    try:
        ...
        html_gen.add_element(f"<li> Longitud:   {longitud.text} {longitud.get('unidad')}</li>")
        html_gen.add_element(f"<li> Anchura:   {anchura.text} {anchura.get('unidad')}</li>")
        html_gen.add_element(f"<li> Fecha:   {root.findtext('circ:fecha', '', ns)}</li>")
        html_gen.add_element(f"<li> Hora:   {root.findtext('circ:hora', '', ns)}</li>")
        html_gen.add_element(f"<li> Vueltas:   {root.findtext('circ:vueltas', '', ns)}</li>")
        html_gen.add_element(f"<li> Localidad:   {root.findtext('circ:localidad', '', ns)}</li>")
        html_gen.add_element(f"<li> País:   {root.findtext('circ:pais', '', ns)}</li>")
        html_gen.add_element(f"<li> Patrocinador:   {root.findtext('circ:patrocinador', '', ns)}</li>")
        ...
        if coords_node is not None:
            ...
            html_gen.add_element('<ul>')
            html_gen.indent()
            html_gen.add_element(f"<li> Latitud:   {coords_node.findtext('circ:latitud', '', ns)}</li>")
            html_gen.add_element(f"<li> Longitud:   {coords_node.findtext('circ:longitud', '', ns)}</li>")
            html_gen.add_element(f"<li> Altitud:   {coords_node.findtext('circ:altitud', '', ns)}</li>")
            html_gen.unindent()
            html_gen.add_element('</ul>')
            html_gen.unindent()
            html_gen.add_element('</section>')
